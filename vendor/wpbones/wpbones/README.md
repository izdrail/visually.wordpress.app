...
You can use [Visually](https://github.com/wpbones/Visually) repo as a boilerplate to create a plugin.
...
You may start from [Visually](https://github.com/wpbones/Visually) repo as a boilerplate to create a WP Bones WordPress plugin.
